...
export const metadata: Metadata = {
  title: 'Mewgenics Items & Gear — Complete Guide (2026)',
  description: 'Comprehensive Mewgenics Items & Gear guide covering equipment tiers, accessories, consumables. Updated for 2026 with the latest strategies and tips.',
};

export default function ItemsGearPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Mewgenics Items & Gear</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Mewgenics Items & Gear guide. This page covers everything you need to know about equipment tiers, accessories, consumables.
