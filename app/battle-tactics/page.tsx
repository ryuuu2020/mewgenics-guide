...
export const metadata: Metadata = {
  title: 'Mewgenics Battle Tactics — Complete Guide (2026)',
  description: 'Comprehensive Mewgenics Battle Tactics guide covering positioning, abilities, enemy weaknesses. Updated for 2026 with the latest strategies and tips.',
};

export default function BattleTacticsPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Mewgenics Battle Tactics</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Mewgenics Battle Tactics guide. This page covers everything you need to know about positioning, abilities, enemy weaknesses.
