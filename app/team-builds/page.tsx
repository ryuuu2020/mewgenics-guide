...
export const metadata: Metadata = {
  title: 'Mewgenics Team Builds — Complete Guide (2026)',
  description: 'Comprehensive Mewgenics Team Builds guide covering best team compositions, synergies, roles. Updated for 2026 with the latest strategies and tips.',
};

export default function TeamBuildsPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Mewgenics Team Builds</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Mewgenics Team Builds guide. This page covers everything you need to know about best team compositions, synergies, roles.
