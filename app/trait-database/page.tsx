...
export const metadata = {
  title: "Trait Database — Coming Soon | Mewgenics",
  description: "Trait Database is coming soon. We are working on a comprehensive guide for Mewgenics.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-center">
      <div className="bg-parchment-light rounded-xl p-10 border border-border-subtle">
        ...
        <h1 className="font-display text-3xl text-ink mb-3">Trait Database</h1>
