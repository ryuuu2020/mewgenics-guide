...
export const metadata = {
  title: "Team Building Guide — Coming Soon | Mewgenics",
  description: "Team Building Guide is coming soon. We are working on a comprehensive guide for Mewgenics.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-center">
      <div className="bg-parchment-light rounded-xl p-10 border border-border-subtle">
        ...
        <h1 className="font-display text-3xl text-ink mb-3">Team Building Guide</h1>
