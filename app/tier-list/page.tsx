...
export const metadata = {
  title: "Cat Class Tier List — Coming Soon | Mewgenics",
  description: "Cat Class Tier List is coming soon. We are working on a comprehensive guide for Mewgenics.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-center">
      <div className="bg-parchment-light rounded-xl p-10 border border-border-subtle">
        ...
        <h1 className="font-display text-3xl text-ink mb-3">Cat Class Tier List</h1>
