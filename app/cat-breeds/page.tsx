...
export const metadata: Metadata = {
  title: 'Mewgenics Cat Breeds — Complete Guide (2026)',
  description: 'Comprehensive Mewgenics Cat Breeds guide covering breed stats, traits, mutations, tier list. Updated for 2026 with the latest strategies and tips.',
};

export default function CatBreedsPage() {
  return (
    <main className="min-h-screen p-8 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-2 text-text-primary">Mewgenics Cat Breeds</h1>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-muted leading-relaxed mb-4">
          Welcome to our comprehensive Mewgenics Cat Breeds guide. This page covers everything you need to know about breed stats, traits, mutations, tier list.
